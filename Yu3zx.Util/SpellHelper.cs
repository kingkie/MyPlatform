...
namespace Yu3zx.Util
{
    ...
    public class SpellHelper
    {
        private static readonly int[] SpellValue =
       {
        ...
        private static readonly string[] SpellString =
        {
            "a", "ai", "an", "ang", "ao",
        ...
        public static string Convert(string str, bool first = false)
        {
            ...
            {
                var array = Encoding.Default.GetBytes(chars[j].ToString());
                ...
                else
                {
                    ...
                    else
                    {
                        for (int i = (SpellValue.Length - 1); i >= 0; i--)
                        {
                            ...
                            {
                                if (first) sb.Append(SpellString[i].Substring(0, 1));
                                else sb.Append(SpellString[i]);
                                break;
                            }
                        }
                    }
